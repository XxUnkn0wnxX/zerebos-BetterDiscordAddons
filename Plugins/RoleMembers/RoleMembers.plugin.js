...
var root_1 = from_html(`<div class="user RoleMembers-1o7otmq" role="button" tabindex="0"><img class="RoleMembers-1o7otmq"/> <span class="RoleMembers-1o7otmq"> </span></div>`);
var root = from_html(`<div class="popout popout-role-members RoleMembers-1o7otmq"><div class="header RoleMembers-1o7otmq"><input type="search" class="RoleMembers-1o7otmq"/></div> <div class="user-list RoleMembers-1o7otmq"></div></div>`);
var $$css = {
  hash: "RoleMembers-1o7otmq",
  code: '.popout.RoleMembers-1o7otmq {--space-xxs: 4px;--space-4: 4px;--space-8: 8px;--space-12: 12px;--radius-xs: 4px;--radius-sm: 8px;--select-option-height: 40px;--opacity-black-16: hsl(0 calc(1*0%) 0% /0.1607843137254902);--background-surface-higher: color-mix(in oklab, hsl(240 calc(1*5.882%) 16.667% /1) 100%, #000 0%);--background-mod-normal: hsl(240 calc(1*4%) 60.784% /0.1607843137254902);--border-subtle: color-mix(in oklab,hsl(240 calc(1*4%) 60.784% /0.12156862745098039) 100%,hsl(0 0% 0% /0.12156862745098039) 0%);--custom-input-background-color: color-mix(in oklab,hsl(0 calc(1*0%) 0% /0.12156862745098039) 100%,hsl(0 0% 0% /0.12156862745098039) 0%);--custom-input-border-color: color-mix(in oklab,hsl(240 calc(1*4%) 60.784% /0.2) 100%,hsl(0 0% 0% /0.2) 0%);--custom-input-hover-border-color: color-mix(in oklab,hsl(240 calc(1*4%) 60.784% /0.2) 100%,hsl(0 0% 0% /0.2) 0%);--custom-input-focus-border-color: color-mix(in oklab, hsl(234.935 calc(1*85.556%) 64.706% /1) 100%, #000 0%);--custom-input-text-color: color-mix(in oklab, hsl(240 calc(1*6.667%) 94.118% /1) 100%, #000 0%);--text-strong: color-mix(in oklab, hsl(0 calc(1*0%) 98.431% /1) 100%, #000 0%);}.popout.RoleMembers-1o7otmq {background-color:var(--background-surface-higher);border:1px solid var(--border-subtle);border-radius:var(--radius-sm);box-shadow:0 2px 8px 0 var(--opacity-black-16);width:222px;display:flex;flex-direction:column;padding:var(--space-4);gap:4px;font-size:16px;font-family:"gg sans","Noto Sans","Helvetica Neue",Helvetica,Arial,sans-serif;}.header.RoleMembers-1o7otmq {display:flex;flex-grow:1;padding:4px;}.header.RoleMembers-1o7otmq input:where(.RoleMembers-1o7otmq) {flex-grow:1;background-color:var(--custom-input-background-color);border:1px solid var(--custom-input-border-color);border-radius:var(--radius-sm);box-sizing:border-box;color:var(--custom-input-text-color);font-size:inherit;max-height:1lh;min-height:calc(var(--select-option-height) - 2px);min-width:min(12ch, 80%);padding-inline:var(--space-12) var(--space-8);}.header.RoleMembers-1o7otmq input:where(.RoleMembers-1o7otmq):hover {border-color:var(--custom-input-hover-border-color);}.header.RoleMembers-1o7otmq input:where(.RoleMembers-1o7otmq):focus {outline:2px solid var(--custom-input-focus-border-color);outline-offset:-2px;}\n\n/* No need for -moz- because discord desktop is chromium */.header.RoleMembers-1o7otmq input:where(.RoleMembers-1o7otmq)::-webkit-search-cancel-button {mask-image:url(data:image/svg+xml;base64,);mask-size:10px 10px;background-color:var(--text-strong);-webkit-appearance:none;width:10px;height:10px;}.user-list.RoleMembers-1o7otmq {height:200px;overflow:hidden scroll;}.user.RoleMembers-1o7otmq {display:flex;gap:10px;flex-grow:1;color:var(--text-strong);min-height:var(--select-option-height);padding:calc(var(--space-xxs) - 1px) var(--space-4) calc(var(--space-xxs) - 1px) var(--space-8);margin:0 4px;align-items:center;cursor:pointer;transition:background-color .15s ease-out;border-radius:var(--radius-xs);box-sizing:border-box;}.user.RoleMembers-1o7otmq:hover {background-color:var(--background-mod-normal);}.user.RoleMembers-1o7otmq img:where(.RoleMembers-1o7otmq) {width:24px;height:24px;border-radius:50%;}.user.RoleMembers-1o7otmq span:where(.RoleMembers-1o7otmq) {text-overflow:ellipsis;line-height:1.25;white-space:nowrap;overflow:hidden;}.user-list.RoleMembers-1o7otmq::-webkit-scrollbar-thumb,\n.user-list.RoleMembers-1o7otmq::-webkit-scrollbar-track {background-clip:padding-box;border-radius:7.5px;border-style:solid;border-width:3px;visibility:hidden;}.user-list.RoleMembers-1o7otmq:hover::-webkit-scrollbar-thumb,\n.user-list.RoleMembers-1o7otmq:hover::-webkit-scrollbar-track {visibility:visible;}.user-list.RoleMembers-1o7otmq::-webkit-scrollbar-track {border-width:initial;background-color:transparent;border:2px solid transparent;}.user-list.RoleMembers-1o7otmq::-webkit-scrollbar-thumb {border:2px solid transparent;border-radius:4px;cursor:move;background-color:rgba(255, 255, 255, 0.3);min-height:40px;}.user-list.RoleMembers-1o7otmq::-webkit-scrollbar {height:8px;width:8px;}'
};
function UserSearchPopout($$anchor, $$props) {
  ...
  const results = user_derived(() => {
    if (!get2(query).trim()) return $$props.users;
    return $$props.users.filter((e) => e.name.toLowerCase().includes(get2(query).toLowerCase()));
  });
  function onKeydown(event2, user) {
    if (event2.key === "Enter" || event2.key === " ") {
      event2.preventDefault();
      $$props.onItemClick?.(event2, user);
    }
  }
  var div = root();
  var div_1 = child(div);
  ...
  each(div_2, 21, () => get2(results), (user) => user.id, ($$anchor2, user) => {
    var div_3 = root_1();
    var img = child(div_3);
    ...
    reset(div_3);
    template_effect(() => {
      set_attribute2(img, "src", get2(user).avatar);
      set_attribute2(img, "alt", `${get2(user).name ?? ""} Avatar`);
      styles = set_style(span, "", styles, { color: get2(user).color });
      set_text(text2, get2(user).name);
    });
    delegated("click", div_3, (event2) => $$props.onItemClick?.(event2, get2(user)));
    delegated("keydown", div_3, (event2) => onKeydown(event2, get2(user)));
    append($$anchor2, div_3);
  });
  reset(div_2);
  reset(div);
  template_effect(() => set_attribute2(input, "placeholder", `Search ${$$props.users.length ?? ""} members...`));
...
function animateLeft(original, endPoint, popout) {
...
var RoleMembers = class extends Plugin {
  ...
  showSveltePopout(guildId, roleId, offset) {
