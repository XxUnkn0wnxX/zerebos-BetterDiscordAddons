...
function UserSearchPopout($$anchor, $$props) {
  ...
  each(div_2, 21, () => get(results), (user) => user.id, ($$anchor2, user) => {
    var div_3 = root_1();
    var img = child(div_3);
    ...
    delegated("click", div_3, (event2) => $$props.onItemClick?.(event2, get(user)));
    delegated("keydown", div_3, (event2) => onKeydown(event2, get(user)));
