...
const {ReactUtils, Utils, Patcher} = BdApi;
...
export default class BetterRoleColors extends Plugin {
    constructor(meta: Meta) {super(meta, Config);}

    promises = {state: {cancelled: false}, cancel() {this.state.cancelled = true;}};
    ...
    onStart() {
        ...
        suppressErrors(this.patchAccountDetails.bind(this), "account details patch")();
        suppressErrors(this.patchVoiceUsers.bind(this), "voice users patch")();
        suppressErrors(this.patchMessageContent.bind(this), "message content patch")();

        this.promises.state.cancelled = false;
        suppressErrors(this.patchAuditLog.bind(this), "audit log patch")(this.promises.state);
        suppressErrors(this.patchTypingUsers.bind(this), "typing users patch")(this.promises.state);
    }
    ...
    patchVoiceUsers() {
        Patcher.after(this.meta.name, VoiceUser.prototype, "renderName", (thisObject, _, returnValue) => {
    ...
    patchMessageContent() {
        ...
        Patcher.after(this.meta.name, MessageContent, "type", (_, [props], returnValue) => {
    ...
    async patchAuditLog(promiseState) {
        ...
        Patcher.after(this.meta.name, UserHook.component.prototype, "render", (thisObject, _, returnValue) => {
    ...
    async patchTypingUsers(promiseState) {
        ...
        if (promiseState.cancelled) return;
        Patcher.after(this.meta.name, TypingUsers.component.prototype, "render", (thisObject, _, returnValue) => {
